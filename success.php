...
?> 	 
		...
		<thead> 
			...
			<tbody> 
		 <?php
			$pes = mysqli_fetch_array(mysqli_query($koneksi,"SELECT*FROM pesanan where user_id='$_SESSION[iam_user]' order by id DESC limit 1"));
			$q = mysqli_query($koneksi,"select*from detail_pesanan where pesanan_id='$pes[id]'");
			$ongkir = $pes['ongkir'];
			$total = 0;
