...
<html lang="en">
  <head>
    <meta charset="utf-8">    
		<title>Go-Mput Halaman Admin</title>
  ...
  $qpesanan = mysqli_query($koneksi,"select*from pesanan where `read`='0'") or die (mysql_error());
  $totalUnRead = mysqli_num_rows($qpesanan);
  // TOTAL PEMBAYARAN YANG BELUM DI VERIFIKASI
  $qPembayaran = mysqli_query($koneksi,"select*from pembayaran where `status`='pending'") or die (mysql_error());
    ...
    <nav class="navbar navbar-default navbar-fixed-top navbar-blue">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">Go-Mput Halaman Admin</a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
            <li><a href="<?php echo $url ?>admin/index.php">Home</a></li>
			<li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Data Catering <span class="caret"></span></a>
            ...
            <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li><a href="laporan_keuntungan.php">Laporan Keuntungan</a></li>
                    </ul>
                  </li>
